# basic prefix sum idea: https://leetcode.com/problems/minimum-time-to-remove-all-cars-containing-illegal-goods/solutions/1749752/c-o-n-easy-dp-solution-with-explanation/
# optimised to single pass: https://leetcode.com/problems/minimum-time-to-remove-all-cars-containing-illegal-goods/solutions/1748704/java-c-python-short-one-pass-o-1-space/ 
class Solution:
