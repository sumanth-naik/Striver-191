# ref: # https://leetcode.com/problems/number-of-matching-subsequences/solutions/1289406/python-binary-search-solution-explained/?orderBy=most_votes
# Key Idea: create charToIndicesMap and use binary search for each char to check isSubsequence
