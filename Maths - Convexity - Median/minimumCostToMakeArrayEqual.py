...
let nums be sorted for simplicity and are n_1, n_2, n_3, .... n_m, but a necessity for the algorithm
let n_k<x<n_k+1
...
But if the cost the same, we can achieve the same min cost if we pick 2 or 5.
    \
     \         /
      \       /
       \ _ _ / 
...
# Also known as weighted-median algo
